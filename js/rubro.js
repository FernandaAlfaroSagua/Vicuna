...
const tabla = $("#dataTableRubro").DataTable({
  language: {
  ...
  columns: [
    ...
    { data: "nombreRubro" },
    {
      defaultContent: "estadoRubro",
      render: function (data, type, row) {
        if (row.estadoRubro == 1) {
...
$("#nombreRubro").change(() => {
  ...
  if (nombre) {
    $("#frm_nombreRubro > input").removeClass("is-invalid");
  } else {
    $("#frm_nombreRubro > input").addClass("is-invalid");
  }
});
...
function validar() {
  if ($("#nombreRubro").val() == "") {
    $("#frm_nombreRubro > input").addClass("is-invalid");
    $("#frm_nombreRubro > div").html("Nombre es un campo requerido");
    $("#nombreRubro").focus();
