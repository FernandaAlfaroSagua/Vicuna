    ...
    $.ajax({
        ...
        success: function(response) {
            response.map(function(item) {
                ...
                locations.push([
                    new google.maps.LatLng(item[2], item[3]), 'Marker' + item[0], item[1]
                ]);
    ...
    $.ajax({
        ...
        success: function(response) {
            response.map(function(item) {
                ...
                locations.push([
                    new google.maps.LatLng(item[13], item[14]), 'Marker' + item[0], item[1]
                ]);
    ...
    $.ajax({
        ...
        success: function(response) {
            response.map(function(item) {
                ...
                locations.push([
                    new google.maps.LatLng(item[5], item[6]), 'Marker' + item[0], item[1]
                ]);
