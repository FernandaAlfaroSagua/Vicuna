          ...
          <div class="container-fluid">
            ...
            <form>
                <div class="mb-3">
                  ...
                  <div id="frm_nombreRubro">
                    <input class="form-control" id="nombreRubro" name="nombreRubro" type="text">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Listado de Rubros</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTableRubro" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
