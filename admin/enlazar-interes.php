...
<!-- sweet alert -->
  ...
  <body id="page-top">
        ...
        <li class="nav-item active">
          ...
          <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                  ...
                  <a class="collapse-item active" href="enlazar-interes.php">Enlazar Punto de Interes</a>
              </div>
          </div> 
        </li>
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Enlazar Ubicaciones QR con en Punto de Interés</h6>
              </div>
            <div class="card-body">
            <form>
                <div class="mb-3">
                  <label for="ubicacion">Ubicaciones QR</label>
                  <div id="frm_ubicacion">
                ...
                <div class="mb-3">
                  <label for="interes">Punto de Interés</label>
                  <div id="frm_interes">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Listado de ubicaciones qr enlazados al punto de interés</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTableVideo" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>ID Ubicaciones QR</th>
                                    <th>Descripcion Ubicacion QR</th>
                                    <th>ID Punto de Interes</th>
                                    <th>Descripcion del Punto de Interes</th>
                                    <th>Editar</th>
                                    <th>Eliminar</th>
                                </tr>
                            </thead>                           
    ...
    <script src="../js/enlazar-interes.js"></script> 
  </body>
</html>
