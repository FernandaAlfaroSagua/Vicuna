          ...
          <div class="container-fluid">
            ...
            <form>
                <div class="mb-3">
                  ...
                  <div id="frm_nombreCalle">
                    <input class="form-control" id="nombreCalle" name="nombreCalle" type="text">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTableCalle" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
