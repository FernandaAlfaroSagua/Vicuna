                ...
                <div class="p-5">
                  ...
                  <form class="user">
                    <div class="form-group">
                      <div id="frm_usuario">
                        <input type="text" class="form-control form-control-user" id="usuario" name="usuario" aria-describedby="user" placeholder="Usuario" />
                        <div class="invalid-feedback"></div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div id="frm_clave">
                        <input type="password" name="clave" class="form-control form-control-user" id="clave" placeholder="Contraseña" />
                        <div class="invalid-feedback"></div>
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div id="frm_button">
                      <button type="button" id="ingresar" name="ingresar" class="btn btn-dark btn-user btn-block">
                        Iniciar Sesión
                      </button>
                      <br>
                      <div class="invalid-feedback"></div>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-2 mt-md-0 my-3 text-center">
          <!-- Content -->
          <img src="../img/Isotipo-white.png" width="100" alt="Logo Vicuña" class="mt-4" />
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-3 my-auto">
          <a href="https://www.youtube.com/channel/UCp3pridu6YCWod4oazXTucw" target="_blank" class="mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="10mm" height="10mm" version="1.1" style="
                  shape-rendering: geometricPrecision;
                  text-rendering: geometricPrecision;
                  image-rendering: optimizeQuality;
                  fill-rule: evenodd;
                  clip-rule: evenodd;
                " viewBox="0 0 164 164" xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs>
                <style type="text/css">
                  <![CDATA[
                  .str0 {
                    stroke: #FEFEFE;
                    stroke-width: 6.20082
                  }
          ...
          <a href="https://www.facebook.com/turismovicuna/" target="_blank" class="mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="10mm" height="10mm" version="1.1" style="
                  ...
                  fill-rule: evenodd;
                  clip-rule: evenodd;
                " viewBox="0 0 133 133" xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs>
                <style type="text/css">
                  <![CDATA[
                  .str0 {
                    stroke: #FEFEFE;
                    stroke-width: 5.04267
                  }
          ...
          <a href="https://www.instagram.com/vicunaturismo/" target="_blank" class="mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="10mm" height="10mm" version="1.1" style="
                  ...
                  fill-rule: evenodd;
                  clip-rule: evenodd;
                " viewBox="0 0 105 105" xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs>
                <style type="text/css">
                  <![CDATA[
                  .str0 {
                    stroke: #FEFEFE;
                    stroke-width: 3.97517
                  }
          ...
          <a href="https://twitter.com/vicunaturismo?lang=es" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="10mm" height="10mm" version="1.1" style="
                  ...
                  fill-rule: evenodd;
                  clip-rule: evenodd;
                " viewBox="0 0 87 87" xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs>
                <style type="text/css">
                  <![CDATA[
                  .str0 {
                    stroke: #FEFEFE;
                    stroke-width: 3.31506
                  }
