...
<body id="page-top">
  ...
  <div id="wrapper">
              ...
              <form>
                ...
                <div class="mb-3">
                  ...
                  <div id="frm_celularEmpresa">
                    <input class="form-control" name="celularEmpresa" id="celularEmpresa" type="tel" placeholder="Ej 912345678" maxlength="9" minlength="9">
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <div id="frm_latitud">
                    <input class="form-control" id="latitud" id="latitud" name="latitud" type="text" disabled>
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
                <div class="mb-3">
                  ...
                  <div id="frm_longitud">
                    <input class="form-control" id="longitud" id="longitud" name="longitud" type="text" disabled>
                    <div class="invalid-feedback"></div>
                  </div>
                </div>
                <div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDDpaIroPBt3YAqP7SwYylETUjBkdZfdUM&libraries=places&callback=initAutocomplete" async defer></script>
