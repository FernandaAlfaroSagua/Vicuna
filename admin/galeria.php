          ...
          <div class="container-fluid">
            ...
            <form >
                <div class="mb-3">
                  ...
                  <div id="frm_nombreGaleria">
                    <input class="form-control" name="nombreGaleria" id="nombreGaleria" type="text">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTableGaleria" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
