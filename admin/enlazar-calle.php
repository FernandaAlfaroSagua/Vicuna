...
<!-- sweet alert -->
  ...
  <body id="page-top">
        ...
        <li class="nav-item active">
          ...
          <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                  ...
                  <a class="collapse-item active" href="enlazar-calle.php">Enlazar Calle</a>
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Enlazar Ubicaciones QR con la Calle</h6>
              </div>
            <div class="card-body">
            <form>
                <div class="mb-3">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Listado de ubicaciones qr enlazados a las calles</h6>
                </div>
                <div class="card-body">
    ...
    <script src="../js/enlazar-calle.js"></script> 
  </body>
</html>
